...
//         <h1>Enter the details of event you want to create</h1>
//     <form onSubmit={handleSubmit}>
      
//       <select placeholder='Select Single or Team' onChange={(e)=>setType(e.target.value)}>
//         <option value="Single" >Single</option>
//         <option value="Team">Team</option>
       
//       </select>
//        <input type="text" placeholder='Enter Event Name' onChange={(e)=>setEname(e.target.value)}/>
//        <input type="text" placeholder='Enter Event Description' onChange={(e)=>setEdesc(e.target.value)}/>
//        <input type="text" placeholder='Enter Event Date' onChange={(e)=>setEdate(e.target.value)}/>
//        <input type="text" placeholder='Enter Event Time' onChange={(e)=>setEtime(e.target.value)}/>
